...
// 모든 예외 클래스는 해당 클래스를 상속받음 (예외와 관련된 메시지, 처리 방법에 대한 예시 정보 등등)

// 자바 클래스 타입의 최상위 클래스 'Object'
...
// >> 개발자가 직접 처리할 수 없음 (메모리 부족, 네트워크 연결 등등)
