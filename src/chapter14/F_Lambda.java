...
// 1. 정적 메소드 참조
// 객체(인스턴스) 생성 없이 사용할 수 있는 메소드
// ClassName::staticMethod
class StaticMethodRef{
	// 정적 메소드: 인스턴스 없이 바로 사용 가능
...
// 4. 임의 객체 인스턴스 메소드 참조
// 특정 객체가 아닌 여러 객체에 공통된 인스턴스 메소드를 사용할 때
...
public class F_Lambda {
	...
	// >> String 클래스 내부의 인스턴스 메소드를 인스턴스인 hello에서 호출 가능
	String hello = "hello";
