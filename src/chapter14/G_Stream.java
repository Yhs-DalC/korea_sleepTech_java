...
public class G_Stream {
	public static void main(String[] args) {
		...
		// 스트림 중간 연산 내부의 람다식: 스트림 내부의 요소값을 하나씩 매개변수에 담음
		// >> 구현부에서 인자로 해당 매개변수와 일치하는 값을 전달하는 경우 메소드 참조 가능
...
//			.forEach(System.out::println);
		...
		// .stream으로 생성된 스트림은 일회성으로만 사용 가능
		// 메소드 체이닝으로 여러 기능을 적용
		// 스트림으로 생성된 데이터를 다시 스트림으로 변경할 수 없음
...
//			.collect(Collectors.toList());
//		 java.lang.IllegalStateException 예외 발생(스트림을 재사용함)
