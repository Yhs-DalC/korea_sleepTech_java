...
public class C_Optional {
	public static void main(String[] args) {
		...
		// .ofNullable() 메소드
		// null일수도 있는 값을 감싸는 메소드
		// null 전달시 빈 Optional객체를 반환
		...
		// 3.Optional 주요 메소드
		// 값이 있는지 확인
		// - isPresent(): 존재 할 경우 true, 존재하지 않을 경우 false
		// - isEmpty():존재 할 경우 false, 존재하지 않을 경우 true
		...
		// null 방지에 대한 필수 값은 직접 값을 반환하고 null 여부 확인을 권장
