...
// 할인 정책 사용시, Product 또는 Product를 상속받는 하위 클래스에서만 적용
...
class DiscountPolicy{
	public static double applyDiscount(List<? extends Product> products, double discountRate) {
		// 리스트 컬랙션 프레임 워크 형식에 Product 타입을 가지거나 해당 타입의 하위 클래스(전자, 가구)만을 허용
		// 상한 제한 와일드 카드
...
public class C_Generic_Prac {
	public static void main(String[] args) {
		...
		double totalFunitures = DiscountPolicy.applyDiscount(furnitures, 0.2);
		
		System.out.println("총 가구 할인액: " + totalFunitures + "원");// 총 가구 할인액: 90.0원
