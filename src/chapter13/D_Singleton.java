...
// -단점: 전역 상태 관리 + 다른 클래스에 영향(결합의 가능성)
//     : 테스트가 어려움
...
class Singleton {
	...
	// 싱글톤 패턴의 전역 접근성을 제공하는 메소드 정의 (인스턴스화 담당)
	public static Singleton getInstance() {
		// 주로 getInstance 메소드명을 사용
		if (instance == null) {
