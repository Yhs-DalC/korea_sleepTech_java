...
// OOP (Objext-Oriented Programming): 객체 지향 프로그래밍
...
// SOLID 원칙 적용 시 주의점
// 적용 순서 X, 모두 필수 X, 서로 독립적 개념 X, 개념적 연관 O

// 상속, 추상화, 디향성, 캡슐화 등은 OOP의 4가지 특징
...
// 올바른 예제 - 기존의 코드를 수정하지 않고, 새로운 기능 확장
...
// 상위 클래스의 객체를 하위 클래스의 객체로 치환하더라도 프로그램의 동작이 일관되게 유지되여야 함
...
// >> 추상적인 메소드를 통해 하위 클래스에서 구체적인 기능의 선택이 가능하도록 설계
