...
/*
 	Mammal 클래스
 	필드: 이름(name), 나이(age)
 	생성자: 매개변수 X 생성자, 매개변수 O 생성자(String name)
 	메소드: 클래스 필드 정보를 출력(displayMammal)
 */
class Mammal {
	String name = "Parent";
...
// 접근제어자가 생략 되어있는 default 값의 경우 같은 패키지 내에서 접근 가능
// 같은 패키지 내에 같은 클래스명 사용이 불가능
//class Animal{
//	
//}
...
/*
 	...
 	필드: name
 	생성자: 매개변수 X 생성자, 매개변수 O생성자(String name)
 	메소드: 클래스 필드 정보를 출력(displayCat)
 */
...
class Cat extends Mammal{
	...
	/*
	 	Cat() {
	 		...
	 		상속받은 자식 클래스의 경우 사용자 정의 부모 생성자의 호출이 없더라도
