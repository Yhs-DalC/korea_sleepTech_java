...
public class B_Enum {
	public static void main(String[] args) {
		// 클래스의 static final 필드 처럼 쓰임: 각 상수는 정의된 Enum 타입으로 간주
		...
		System.out.println(authorSize + "'s ml: " + authorSize.getMl() + "ml");// LARGE's ml: 400ml
	}
}
