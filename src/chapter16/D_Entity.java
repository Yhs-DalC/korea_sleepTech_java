...
// DAO(Data Access Object): Database에 접근하는 역할을 하는 개체
...
// - 비즈니스 로직에서 DB의 직접적인 조작 없이 데이터를 다룸
...
// - JPA(Java Persistance API)와 같은 ORM(Object-Related Mapping) 툴에서 사용
